...
contract YunoImToken is ERC721, ERC721Metadata
{
    // ERC721Metadata variable..
    string public tokenName = "YunoIm";
    string public tokenSymbol = "YI";

    // 0 : ipfs://blabla..../0.json
    // 2 : ipfs://blabla..../2.json
    ...
    //approvedOfOwner[0xA][OxB] == true? false? 
                ...
                public override payable
    {
        ...
        initialMintAddressByTokenId[tokenId].transfer(msg.value*0.2);
        from.transfer(msg.value * 0.8 );;
    ...
    mapping(uint256=>address) initialMintAddressByTokenId;
    function mint(address to, uint256 tokenId, string memory uri) public 
    {
        ...
        initialMintAddressByTokenId[tokenId] = to;
    ...
    function approve(address approved, uint256 tokenId) public override  payable
    {
        ...
        require(tokenOwner == msg.sender, "not permission");
